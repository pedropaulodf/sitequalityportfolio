...
export default function Privacidade() {
  return (
    <>
      <Head>
        <title>Privacidade | Quality Systems</title>
        <meta
          name="description"
      ...
      {/* RENOMEEI A PÁGINA NOVA COM .html PARA ENVIAR PROBLEMAS ONDE FOI USADO O LINK ANTIGO */}
      
      {/* PÁGINA ANTIGA */}
      {/* http://qualitysys.com.br/novo/privacidade.html */}
      ...
      <main className={styles.container}>
        ...
        <section className={styles.content}>
          <div className={styles.terms}>
            ...
            <p>
              Quality Systems LTDA built the App do Sócio app as a Free app.
              This SERVICE is provided by Quality Systems LTDA at no cost and is
            ...
            <p>
              ...
              our Terms and Conditions, which is accessible at App do Sócio
              unless otherwise defined in this Privacy Policy.
            </p>
            <p className={styles.title}>Information Collection and Use</p>
            <p>
            ...
            <p className={styles.title}>Log Data</p>
            <p>
            ...
            <p className={styles.title}>Children’s Privacy</p>
            <p>
            ...
            <p className={styles.title}>Changes to This Privacy Policy</p>
            <p>
            ...
            <p>This policy is effective as of 2020-08-28</p>
            <p className={styles.title}>Contact Us</p>
            <p>
              If you have any questions or suggestions about our Privacy Policy,
              do not hesitate to contact us at eduardoccost@outlook.com.
            </p>
            <p>
